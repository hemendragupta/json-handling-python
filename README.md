Flattens JSON function in Python. This python code flattens the hierarchy of any deep nested JSON in simple readable format. 

# Example:
### Let say you want to flatten below Json file:
